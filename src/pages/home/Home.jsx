...
const Home = () => {
  ...
  return (
    <section className="overflow-hidden">
      <Banner></Banner>
      <h2 className="text-4xl text-center mb-16 mt-28 uppercase">
        Trusted brands
      </h2>
      ...
      <div className="w-10/12 mx-auto">
        <h1 className="text-4xl font-semibold text-center mt-40 mb-16">
          RECENT ITEMS
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="bg-stone-950">
            ...
            <div className="flex items-center justify-between">
              <h3 className="text-xl pl-5">2022 Tesla Roadster</h3>
              <h4 className="text-xl bg-red-500 pt-2 pb-3 px-2">
                Buy for <span className="text-2xl font-medium">$90000</span>
              </h4>
            </div>
          </div>
          <div className="bg-stone-950">
            ...
            <div className="flex items-center justify-between">
              <h3 className="text-xl pl-5">2021 Honda Accord</h3>
              <h4 className="text-xl bg-red-500 pt-2 pb-3 px-2">
                Buy for <span className="text-2xl font-medium">$35000</span>
              </h4>
            </div>
          </div>
          <div className="bg-stone-950">
            ...
            <div className="flex items-center justify-between">
              <h3 className="text-xl pl-5">2020 BMW M440i</h3>
              <h4 className="text-xl bg-red-500 pt-2 pb-3 px-2">
                Buy for <span className="text-2xl font-medium">$55000</span>
              </h4>
            </div>
          </div>
          <div className="bg-stone-950">
            ...
            <div className="flex items-center justify-between">
              <h3 className="text-xl pl-5">2016 Toyota Camry</h3>
              <h4 className="text-xl bg-red-500 pt-2 pb-3 px-2">
                Buy for <span className="text-2xl font-medium">$20000</span>
              </h4>
            </div>
          </div>
        </div>
      ...
      <div className="my-28">
        ...
        <div className="flex justify-center">
          <button className="btn bg-red-400 border-none rounded-full text-gray-900 mb-6">Shop now</button>
        </div>
        <div className="flex justify-center">
